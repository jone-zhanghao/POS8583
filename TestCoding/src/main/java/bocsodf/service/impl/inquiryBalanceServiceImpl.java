package bocsodf.service.impl;

import bocsodf.constant.PosCode;
import bocsodf.service.inquiryBalanceService;
...
public class inquiryBalanceServiceImpl implements inquiryBalanceService {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            //----------------test start---------------
//            byte[] abc = new byte[75];
//            byte[] abc = FieldUntil.subBytes(send,50,67);
//            System.arraycopy(send, 50, abc, 0, 75);

//            byte[] abc = new String(send, 50, 75 ,"ISO-8859-1").getBytes("ISO-8859-1");
//            byte[] abc = new String(send, 50, 75 ,"Unicode").getBytes("Unicode");
//            byte[] abc = new String(send, 50, 75 ,"GBK").getBytes("GBK");
//            byte[] abc = new String(send, 50, 75 ).getBytes();
//            byte[] abc = new String(send, 50, 75 ,"UTF-16").getBytes("UTF-16");
//            byte[] abc = new String(send, 50, 75 ,"UTF-8").getBytes("UTF-8");
//            byte[] abc = new String(send, 50, 75 ,packet_encoding).getBytes(packet_encoding);
